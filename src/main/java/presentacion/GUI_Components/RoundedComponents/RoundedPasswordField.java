...
public class RoundedPasswordField extends JPasswordField implements RoundedFields{
    /**
	 * 
	 */
    ...
    public RoundedPasswordField(int columns) {
        ...
        setEchoChar((char)0); 							// Desactiva el enmascarado
        ...
        addFocusListener(new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				if(showingHint) {
			        ...
			        setEchoChar('*'); 						// Activa el enmascarado
					showingHint = false;
				}
			}
